...
export const TAG_MOOD_MAP: Record<string, Mood[]> = {
  ...
  // ==========================================
  // THINKING mood → maps to 'feels' (intellectual/literary engagement)
  // Exception: speculative stays as 'escape' (worldbuilding/fantasy)
  // ==========================================
  'thought-provoking': ['feels'],
  'thought provoking': ['feels'],
  'literary': ['feels'],
  'literary fiction': ['feels'],
  'philosophical': ['feels'],
  'philosophy': ['feels'],
  'complex': ['feels'],
  'layered': ['feels'],
  'character study': ['feels'],
  'character-driven': ['feels'],
  'character driven': ['feels'],
  'moral dilemma': ['feels'],
  'morally-grey': ['feels'],
  'morally grey': ['feels'],
  'social commentary': ['feels'],
  'speculative': ['escape', 'feels'],
  'cerebral': ['feels'],
  'introspective': ['feels'],
  'ambitious': ['feels'],
  'challenging': ['feels'],
  'mind-bending': ['feels', 'thrills'],
  'intelligent': ['feels'],
  'experimental': ['feels'],
  'dual-timeline': ['feels'],
  'dual timeline': ['feels'],
  'antihero': ['feels', 'thrills'],
  'political': ['feels', 'thrills'],
  'power': ['feels'],
  'class': ['feels'],
  'classics': ['feels'],
  'classic': ['feels'],
