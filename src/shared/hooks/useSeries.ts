/**
 * src/shared/hooks/useSeries.ts
 *
 * Hook to fetch and return series for a library.
 *
 * Moved from features/series/hooks/ to shared/hooks/ because it's
 * consumed by browse, series, and shared features (useBrowseCounts).
 */
...
import { SeriesInfo } from '@/features/series/services/seriesAdapter';
