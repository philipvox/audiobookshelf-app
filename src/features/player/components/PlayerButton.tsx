 ...
 * Three variants: rewind, fastforward, play (with accent color icon)
 */
...
export type ButtonVariant = 'rewind' | 'fastforward' | 'play';
...
export function PlayerButton({
  ...
  const iconColor = variant === 'play' ? accentColor : 'white';
