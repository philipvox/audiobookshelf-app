/**
 * src/shared/hooks/useAuthors.ts
 *
 * Hook to fetch and return authors for a library.
 *
 * Moved from features/author/hooks/ to shared/hooks/ because it's
 * consumed by browse and author features.
 */
