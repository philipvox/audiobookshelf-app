/**
 * src/shared/components/PlayerIcons.tsx
 *
 * Shared SVG icons for player components.
 * Centralizes icon definitions to prevent duplication across sheets and screens.
 *
 * Moved from src/features/player/components/PlayerIcons.tsx to shared
 * since these icons are used across multiple features (browse, search, book-detail).
 */
