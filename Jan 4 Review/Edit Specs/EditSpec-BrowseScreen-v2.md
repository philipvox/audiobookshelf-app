# Edit Specification: Browse/Discover Screen (v2)

**Version:** 2 (post-validation)
**Changes from v1:** Added dependency on SharedUtilities for getFeaturedReason, clarified useFilteredLibrary dependency
...
|-----------|------------|
| useFeaturedData | 0.1 SharedUtilities (getFeaturedReason) |
| useGenreData, useMoodData | 2.15 useFilteredLibrary |
| All discover hooks | 2.1 Cross-feature imports (kidModeStore moved) |
...
| getFeaturedReason undefined | Validation | Medium |
...
import { getFeaturedReason } from '@/shared/utils/featuredReason'; // From SharedUtilities (0.1)
...
| getFeaturedReason | Depends on 0.1 SharedUtilities |
