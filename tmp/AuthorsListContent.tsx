 ...
 *
 * Browse screen with top tabs for Series, Authors, and Narrators.
 * Consolidates discovery features into a single tab.
 */
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        <TopTab.Screen
          name="Series"
          component={SeriesListContent}
          options={{ tabBarLabel: 'Series' }}
        />
        <TopTab.Screen
          name="Authors"
          component={AuthorsListContent}
          options={{ tabBarLabel: 'Authors' }}
        />
        <TopTab.Screen
          name="Narrators"
          component={NarratorsListContent}
          options={{ tabBarLabel: 'Narrators' }}
        />
        <TopTab.Screen
          name="Collections"
          component={CollectionsListContent}
