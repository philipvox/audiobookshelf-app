/**
 * src/shared/components/CompleteBadge.tsx
 *
 * Visual badge indicator for books marked as complete.
 * Shows a checkmark overlay on book covers.
 *
 * Moved from features/completion/components/ to shared/components/ because it's
 * consumed by browse, library, and completion features.
 */

import React from 'react';
import { View, StyleSheet } from 'react-native';
import { Check, CheckCircle } from 'lucide-react-native';
import { useIsComplete } from '@/shared/stores/completionStore';
