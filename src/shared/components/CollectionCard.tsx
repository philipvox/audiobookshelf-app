 ...
 *
 * Moved from src/features/collections/components/CollectionCard.tsx to shared
...
export const CollectionCard = memo(function CollectionCard({ collection }: CollectionCardProps) {
  ...
  return (
    <TouchableOpacity style={styles.container} onPress={handlePress} activeOpacity={0.7} accessibilityRole="button" accessibilityLabel={`Open collection ${collection.name}, ${bookCount} ${bookCount === 1 ? 'book' : 'books'}`}>
