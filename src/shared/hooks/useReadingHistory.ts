/**
 * src/shared/hooks/useReadingHistory.ts
 *
 ...
 *
 * Moved from features/reading-history-wizard/hooks/ to shared/hooks/ because it's
 * consumed by browse, library, and reading-history-wizard features.
 */
