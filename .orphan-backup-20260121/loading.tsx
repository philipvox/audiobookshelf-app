...
const LoadingFrame: React.FC<{
  ...
  <Svg width={width} height={height} viewBox="0 0 128 136" fill="none">
    ...
    {/* Loading dots with inner shadow simulation */}
    <G>
      {/* Inner shadow layers - offset down 2px */}
      <Circle cx="40" cy="70" r="9" fill="black" fillOpacity={0.35 * dotOpacities[0]} />
      <Circle cx="64" cy="70" r="9" fill="black" fillOpacity={0.35 * dotOpacities[1]} />
      <Circle cx="88" cy="70" r="9" fill="black" fillOpacity={0.35 * dotOpacities[2]} />
      {/* Main dots */}
