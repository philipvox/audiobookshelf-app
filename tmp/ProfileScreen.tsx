 ...
 *
 * Profile screen showing user info, server connection, and settings.
 */
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        {/* Storage Card - Placeholder for future downloads */}
        <Card variant="elevated" padding={5} style={styles.card}>
...
const styles = StyleSheet.create({
  ...
  content: {
    paddingBottom: theme.spacing[32] + 60, // Space for mini player + tab bar
  },
  header: {
