/**
 * src/shared/stores/starPositionStore.ts
 *
 * Persisted store for gold star sticker positions on book covers.
 * Each book can have multiple stars placed by double-tapping.
 *
 * Moved from features/book-detail to shared because it's consumed by
 * home (BookSpineVertical), library (AllBooksScreen), and shared components.
 */
