/**
 * src/shared/stores/completionStore.ts
 *
 ...
 *
 * Moved from features/completion to shared because it's consumed by
 * library (useLibraryData) and shared components (CompleteBadge, BookContextMenu).
 */
