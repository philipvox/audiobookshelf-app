/**
 * src/shared/hooks/useNarrators.ts
 *
 * Hook to fetch and return narrators extracted from library items.
 *
 * Moved from features/narrator/hooks/ to shared/hooks/ because it's
 * consumed by browse and narrator features.
 */
